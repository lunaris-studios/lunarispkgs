# `talismanpkgs` release and maintenance policy
...
We encourage everyone to run the [latest stable release](https://github.com/toyboxco/talismanpkgs/releases) (the latest stable release is also reflected in the current state of the [master branch](https://github.com/toyboxco/talismanpkgs))
