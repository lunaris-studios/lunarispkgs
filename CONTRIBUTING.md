...
1. [Install talismanpkgs](https://github.com/toyboxco/talismanpkgs/blob/master/docs/development/installation.md) for latest stable version of the **talismanpkgs CLI tool**.
