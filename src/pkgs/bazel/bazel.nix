...
let
  ...
  srcDepsSet =
    let
      srcs = (builtins.fromJSON (builtins.readFile (./deps + "/${version}.json")));
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    ./patch/trim-last-argument-to-gcc-if-empty.patch
    ...
    (substituteAll {
      src = ./patch/strict_action_env.patch;
    ...
    (substituteAll {
      src = ./patch/bazel_rc.patch;
      bazelSystemBazelRCPath = bazelRC;
    })
  ] ++ lib.optional enableNixHacks ./patch/nix-hacks.patch;
  ...
  passthru.tests =
    let
      ...
      bazelWithNixHacks = bazelSelf.override { enableNixHacks = true; };
